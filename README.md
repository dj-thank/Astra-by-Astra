...
- 地球・月・土星の間を自由飛行。自動ツアーから途中で手動操縦へ。
- 探査船の操縦席と三人称視点を切り替え。
- 地球上空、夜景、朝日・夕焼け、宇宙から眺める地球。
...
対象はWindows 11 / 64 bit / DirectX 12対応GPUです。開発時の描画目標は4K・30fpsですが、GPUや場面により変わります。まず低めの解像度から調整してください。詳細地表の取得にはインターネット接続とキャッシュ用の空き容量が必要です。
