...
ids=[22493,22494,22495,22496,22497,22498,22500,22502,22504,22505,22506,22507,22508,22509,22511,22512,22513,22514,22515,22517,22518,22519]
...
Path('work/lunar-panorama/full_cameras.json').write_text(json.dumps(out,indent=2),encoding='utf-8')
